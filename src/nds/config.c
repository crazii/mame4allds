...
void get_rom_sample_path (int argc, char **argv, int game_index)
{
  ...
  char text[256];
	...
	sprintf(text,"%s/roms",gameDir); rompath    = get_string ("directory", "rompath",    NULL, "/MAME/roms");
	sprintf(text,"%s/samples",gameDir); samplepath = get_string ("directory", "samplepath", NULL, "/MAME/samples");
...
{
  char text[256];
  sprintf(text,"%s/inp/",gameDir); inpdir = get_string ("directory", "inp",     NULL, text);
}
...
void parse_cmdline (int argc, char **argv, int game_index)
{
  ...
  //char text[256];
  /*sprintf(text,"%s\\nvram\\",gameDir);*/	nvdir      = get_string ("directory", "nvram",   NULL, "/MAME/nvram");
	/*sprintf(text,"%s\\hi\\",gameDir);	*/hidir      = get_string ("directory", "hi",      NULL, "/MAME/hi");
	/*sprintf(text,"%s\\cfg\\",gameDir);*/	cfgdir     = get_string ("directory", "cfg",     NULL, "/MAME/cfg");
	/*sprintf(text,"%s\\snap\\",gameDir);*/	screenshotdir = get_string ("directory", "snap",     NULL, "/MAME/snap");
	/*sprintf(text,"%s\\memcard\\",gameDir);*/	memcarddir = get_string ("directory", "memcard", NULL,"/MAME/memcard");
	/*sprintf(text,"%s\\sta\\",gameDir);*/	stadir     = get_string ("directory", "sta",     NULL, "/MAME/sta");
	/*sprintf(text,"%s\\artwork\\",gameDir);*/	artworkdir = get_string ("directory", "artwork", NULL, "/MAME/artwork");

	cheatdir = get_string ("directory", "cheat", NULL, "/MAME/");
