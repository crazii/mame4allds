...
//ALEK #define READ_WORD(a)		  ((INT16)(*(UINT8 *)a | (*((UINT8 *)a+1) << 8)))
//ALEK #define WRITE_WORD(a,d)  do { *(UINT8 *) (a) = (UINT8) (d); *((UINT8 *) (a+1)) = ((d)>>8); } while (0)
//ALEK #define COMBINE_WORD_MEM(a,d) WRITE_WORD((a), (READ_WORD(a) & ((d) >> 16)) | (d))
