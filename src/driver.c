...
#if   MODULE_VectSega
#include "VectSega_driver.c"
#elif   MODULE_Capcom
#include "Capcom_driver.c"
#elif   MODULE_Konami
#include "Konami_driver.c"
#elif   MODULE_Classic
#include "Classic_driver.c"
#elif   MODULE_DeasIrem
#include "DeasIrem_driver.c"
#elif   MODULE_AtarNamco
#include "AtarNamco_driver.c"
#elif   MODULE_Others
#include "Others_driver.c"
#elif   MODULE_Others2
#include "Others2_driver.c"
#elif   MODULE_Neogeo
#include "Neogeo_driver.c"
#else
