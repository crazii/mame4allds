...
void cheat_insert_new (int cheat_num)
{
	...
	CheatTable[cheat_num].subcheat = (struct subcheat_struct*)calloc(1, sizeof (struct subcheat_struct));
...
void subcheat_insert_new (int cheat_num, int subcheat_num)
{
	...
	CheatTable[cheat_num].subcheat = (struct subcheat_struct*)realloc(CheatTable[cheat_num].subcheat, sizeof (struct subcheat_struct) * (CheatTable[cheat_num].num_sub + 2));
...
void subcheat_delete (int cheat_num, int subcheat_num)
{
	...
	CheatTable[cheat_num].subcheat = (struct subcheat_struct*)realloc(CheatTable[cheat_num].subcheat, sizeof (struct subcheat_struct) * (CheatTable[cheat_num].num_sub));
	if (CheatTable[cheat_num].subcheat == NULL) return;
...
// ALEK no cheat actually
    ...
    /* ALEK : stop if nothing good */
    if (strlen(curline) == 0) break;
...
//		if (CPU_AUDIO_OFF(temp_cpu)) continue;
		...
		CheatTable[LoadedCheatTotal].subcheat = (struct subcheat_struct*)realloc(CheatTable[LoadedCheatTotal].subcheat, sizeof (struct subcheat_struct) * (sub + 1));
