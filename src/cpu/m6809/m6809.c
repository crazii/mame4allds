...
#define DIRWORD(w) {DIRECT;w.d=RM16_6809(EAD);}
#define EXTBYTE(b) {EXTENDED;b=RM(EAD);}
#define EXTWORD(w) {EXTENDED;w.d=RM16_6809(EAD);}
...
INLINE UINT32 RM16_6809( UINT32 Addr )
{
	return (RM(Addr) << 8) | (RM((Addr+1)&0xffff));
}

INLINE void WM16_6809( UINT32 Addr, PAIR *p )
{
	WM( Addr, p->b.h );
...
INLINE void fetch_effective_address( void )
{
	...
	l_0x90: EA=X;	X++;						EAD=RM16_6809(EAD);	m6809_ICount-=5;   return; /* Indirect ,R+ not in my specs */
	l_0x91: EA=X;	X+=2;						EAD=RM16_6809(EAD);	m6809_ICount-=6;   return;
	l_0x92: X--; 	EA=X;						EAD=RM16_6809(EAD);	m6809_ICount-=5;   return;
	l_0x93: X-=2;	EA=X;						EAD=RM16_6809(EAD);	m6809_ICount-=6;   return;
	l_0x94: EA=X;								EAD=RM16_6809(EAD);	m6809_ICount-=3;   return;
	l_0x95: EA=X+SIGNED(B);						EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0x96: EA=X+SIGNED(A);						EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0x98: IMMBYTE(EA); 	EA=X+SIGNED(EA);	EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0x99: IMMWORD(ea); 	EA+=X;				EAD=RM16_6809(EAD);	m6809_ICount-=7;   return;
	l_0x9b: EA=X+D;								EAD=RM16_6809(EAD);	m6809_ICount-=7;   return;
	l_0x9c: IMMBYTE(EA); 	EA=PC+SIGNED(EA);	EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0x9d: IMMWORD(ea); 	EA+=PC; 			EAD=RM16_6809(EAD);	m6809_ICount-=8;   return;
	l_0x9f: IMMWORD(ea); 						EAD=RM16_6809(EAD);	m6809_ICount-=8;   return;
	...
	l_0xb0: EA=Y;	Y++;						EAD=RM16_6809(EAD);	m6809_ICount-=5;   return;
	l_0xb1: EA=Y;	Y+=2;						EAD=RM16_6809(EAD);	m6809_ICount-=6;   return;
	l_0xb2: Y--; 	EA=Y;						EAD=RM16_6809(EAD);	m6809_ICount-=5;   return;
	l_0xb3: Y-=2;	EA=Y;						EAD=RM16_6809(EAD);	m6809_ICount-=6;   return;
	l_0xb4: EA=Y;								EAD=RM16_6809(EAD);	m6809_ICount-=3;   return;
	l_0xb5: EA=Y+SIGNED(B);						EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xb6: EA=Y+SIGNED(A);						EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xb8: IMMBYTE(EA); 	EA=Y+SIGNED(EA);	EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xb9: IMMWORD(ea); 	EA+=Y;				EAD=RM16_6809(EAD);	m6809_ICount-=7;   return;
	l_0xbb: EA=Y+D;								EAD=RM16_6809(EAD);	m6809_ICount-=7;   return;
	l_0xbc: IMMBYTE(EA); 	EA=PC+SIGNED(EA);	EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xbd: IMMWORD(ea); 	EA+=PC; 			EAD=RM16_6809(EAD);	m6809_ICount-=8;   return;
	l_0xbf: IMMWORD(ea); 						EAD=RM16_6809(EAD);	m6809_ICount-=8;   return;
	...
	l_0xd0: EA=U;	U++;						EAD=RM16_6809(EAD);	m6809_ICount-=5;   return;
	l_0xd1: EA=U;	U+=2;						EAD=RM16_6809(EAD);	m6809_ICount-=6;   return;
	l_0xd2: U--; 	EA=U;						EAD=RM16_6809(EAD);	m6809_ICount-=5;   return;
	l_0xd3: U-=2;	EA=U;						EAD=RM16_6809(EAD);	m6809_ICount-=6;   return;
	l_0xd4: EA=U;								EAD=RM16_6809(EAD);	m6809_ICount-=3;   return;
	l_0xd5: EA=U+SIGNED(B);						EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xd6: EA=U+SIGNED(A);						EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xd8: IMMBYTE(EA); 	EA=U+SIGNED(EA);	EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xd9: IMMWORD(ea); 	EA+=U;				EAD=RM16_6809(EAD);	m6809_ICount-=7;   return;
	l_0xdb: EA=U+D;								EAD=RM16_6809(EAD);	m6809_ICount-=7;   return;
	l_0xdc: IMMBYTE(EA); 	EA=PC+SIGNED(EA);	EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xdd: IMMWORD(ea); 	EA+=PC; 			EAD=RM16_6809(EAD);	m6809_ICount-=8;   return;
	l_0xdf: IMMWORD(ea); 						EAD=RM16_6809(EAD);	m6809_ICount-=8;   return;
	...
	l_0xf0: EA=S;	S++;						EAD=RM16_6809(EAD);	m6809_ICount-=5;   return;
	l_0xf1: EA=S;	S+=2;						EAD=RM16_6809(EAD);	m6809_ICount-=6;   return;
	l_0xf2: S--; 	EA=S;						EAD=RM16_6809(EAD);	m6809_ICount-=5;   return;
	l_0xf3: S-=2;	EA=S;						EAD=RM16_6809(EAD);	m6809_ICount-=6;   return;
	l_0xf4: EA=S;								EAD=RM16_6809(EAD);	m6809_ICount-=3;   return;
	l_0xf5: EA=S+SIGNED(B);						EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xf6: EA=S+SIGNED(A);						EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xf8: IMMBYTE(EA); 	EA=S+SIGNED(EA);	EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xf9: IMMWORD(ea); 	EA+=S;				EAD=RM16_6809(EAD);	m6809_ICount-=7;   return;
	l_0xfb: EA=S+D;								EAD=RM16_6809(EAD);	m6809_ICount-=7;   return;
	l_0xfc: IMMBYTE(EA); 	EA=PC+SIGNED(EA);	EAD=RM16_6809(EAD);	m6809_ICount-=4;   return;
	l_0xfd: IMMWORD(ea); 	EA+=PC; 			EAD=RM16_6809(EAD);	m6809_ICount-=8;   return;
	l_0xff: IMMWORD(ea); 						EAD=RM16_6809(EAD);	m6809_ICount-=8;   return;
